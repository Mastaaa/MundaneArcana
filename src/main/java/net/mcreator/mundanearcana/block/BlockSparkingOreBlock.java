...
package net.mcreator.mundanearcana.block;
...
import net.mcreator.mundanearcana.item.ItemSparkingPebbleItem;
...
public class BlockSparkingOreBlock extends MundanearcanaModElements.ModElement {
	@ObjectHolder("mundanearcana:block_sparking_ore")
	public static final Block block = null;
	public BlockSparkingOreBlock(MundanearcanaModElements instance) {
		super(instance, 10);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(ItemSparkingPebbleItem.block, (int) (1)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("mundanearcana:block_sparking_ore_match"),
