...
import net.mcreator.mundanearcana.procedures.PopRockItemRightClickedOnBlockProcedure;
...
public class PopRockItemItem extends MundanearcanaModElements.ModElement {
	@ObjectHolder("mundanearcana:pop_rock_item")
	public static final Item block = null;
	public PopRockItemItem(MundanearcanaModElements instance) {
		super(instance, 2);
	}
